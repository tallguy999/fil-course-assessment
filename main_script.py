...
# df_crimes = mf.Get_Crimes('data/2019-09-metropolitan-street.csv', boroughs, [target_crime])
# df_crimes = mf.Get_Crimes('data/2019-10-metropolitan-street.csv', boroughs, [target_crime])
df_crimes = mf.Get_Crimes('data/2019-11-metropolitan-street.csv', boroughs, [target_crime])
...
X_Rented = X[:,14] # Rented Local Authority is column 16
X_Rented = X_Rented.reshape(-1, 1)
reg = LinearRegression()
reg.fit(X_Rented, y)
prediction_space = np.linspace(min(X_Rented), max(X_Rented)).reshape(-1, 1)
plt.rcParams["figure.figsize"] = [10, 10]
plt.scatter(X_Rented, y, color='blue')
